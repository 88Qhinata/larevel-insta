...
class PostController extends Controller
{
    ...
    public function destroy($id){
        ...
        #2. Add a route inside web.php
        #3. Use the route inside the delete modal folder.
        ...
        #↓これらはいらない
        #これをやるらなら別にfunctionを作る
        // $post = $this->post->findOrFail($id)->forceDelete();
        // $this->deleteCategory($post->category);
        // $this->deleteDescription($post->description);
